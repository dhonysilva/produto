defmodule ProdutoWeb.UserLiveTest do
  use ProdutoWeb.ConnCase

  import Phoenix.LiveViewTest
  import Produto.AccountsFixtures

  @create_attrs %{role: "some role", username: "some username", full_name: "some full_name", email: "some email"}
  @update_attrs %{role: "some updated role", username: "some updated username", full_name: "some updated full_name", email: "some updated email"}
  @invalid_attrs %{role: nil, username: nil, full_name: nil, email: nil}
