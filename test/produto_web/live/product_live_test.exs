defmodule ProdutoWeb.ProductLiveTest do
  use ProdutoWeb.ConnCase

  import Phoenix.LiveViewTest
  import Produto.CatalogFixtures

  @create_attrs %{description: "some description", title: "some title", price: "120.5", view: 42}
  @update_attrs %{description: "some updated description", title: "some updated title", price: "456.7", view: 43}
  @invalid_attrs %{description: nil, title: nil, price: nil, view: nil}
